        ...
        BottomNavigationView.OnNavigationItemSelectedListener { item ->
            when (item.itemId) {
                R.id.scan_take_photo -> {
                    captureImage(); return@OnNavigationItemSelectedListener true
                }
                R.id.scan_convert -> {
                    done(); return@OnNavigationItemSelectedListener true
                }
                R.id.scan_flash_options -> {
                    showFlashOptionsMenu(); return@OnNavigationItemSelectedListener true
                }
            }
            false
        }
